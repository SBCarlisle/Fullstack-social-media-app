 ...
 export default class search {
   ...
   renderResultsHTML(posts){
     console.log('inside render results')
     if(posts.length){
   ...
   openOverlay(){
     ...
     //because this div was hidden untill the above line of code ran, we can wait 50ms untill we try to focus it to avoid problems with certain browsers
